...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="img-box" style="max-width:843px;">
		<img src="../../img/portfolio/paul-home.png" alt="consummatumest.com homepage" />
		<p class="caption">the image during the day looks normally colorized</p>
	</div>
				
	<p>Paul also had me create a script that would colorize the image as a whole during the day - or rather, as a funciton of the number of hours away from high noon.
	So, when the site is viewed at 12:00pm, the image is fully colorized, and the background looks light. When viewed at 12:00am, the background will be dark, and 
	the home page image will be fully black and white. Thus, the dynamic colorization is most noticable at hours closest to midnight. To view the image colorization
	in aciton on the site, visit <a href="https://consummatumest.com/" title="Paul Martinus home page" target="_blank">consummatumest.com</a>.</p>
